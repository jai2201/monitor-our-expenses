...
from .views import (
    CustomUserCreate, VerifyEmail, ResendEmailVerification, ChangePassword, SendForgotPasswordEmail,
    ResetForgotPassword, UpdateBaseUserProfile, ContactAdmin
)
...
urlpatterns = [
    ...
    path('contact-admin/', ContactAdmin.as_view(), name="contact_admin"),
]